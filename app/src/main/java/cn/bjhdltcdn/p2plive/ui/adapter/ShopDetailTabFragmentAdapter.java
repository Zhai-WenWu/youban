 ...
 */
public class ShopDetailTabFragmentAdapter extends FragmentPagerAdapter {
    ...
    public ShopDetailTabFragmentAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public View getTabView(final int position) {
        View view = View.inflate(App.getInstance(), R.layout.shop_detail_tab_item_layout, null);
