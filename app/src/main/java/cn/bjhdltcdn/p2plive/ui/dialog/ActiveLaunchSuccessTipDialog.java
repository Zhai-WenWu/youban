 ...
 */
public class ActiveLaunchSuccessTipDialog extends DialogFragment {
    ...
    private int gravity;
    private boolean isCloseViewShow;
    ...
    public void setCloseViewShow(boolean closeViewShow) {
        isCloseViewShow = closeViewShow;
    }
    ...
    public ActiveLaunchSuccessTipDialog() {
...
//        });
    ...
    private void initView() {
        ...
        if (isCloseViewShow) {
            closeView = rootView.findViewById(R.id.iv_close);
