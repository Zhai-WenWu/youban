 ...
 */
public class AssociationTabFragmentAdapter extends FragmentPagerAdapter {
    ...
    public AssociationTabFragmentAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public View getTabView(final int position) {
        ...
        switch (position) {
            ...
            default:
                ...
                tabIndicatorView.setBackgroundColor(App.getInstance().getResources().getColor(R.color.color_ffffff));
                break;
