 ...
 */
public class VideoGroupTransferhostingTipDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.dialog_video_group_transferhosting, null);
        initView();
        // 触摸内容区域外的需要关闭对话框
    ...
    private void initView() {
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EventBus.getDefault().post(new VideoGroupTransferHostingEvent());
                onDismiss();
            }
        });
    }
