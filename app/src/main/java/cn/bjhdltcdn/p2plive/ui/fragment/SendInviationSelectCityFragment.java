...
public class SendInviationSelectCityFragment extends BaseFragment implements BaseView {
    ...
    private long userId;
    private List<Long> hobbyIds,selectCityPerson;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        selectCityPerson= (List<Long>) mActivity.getIntent().getSerializableExtra(Constants.Fields.SELECT_CITY_PERSON);
        init();
    }
                    ...
                    if (sendActivityInviationResponse.getCode() == 200) {
                        ...
                        if (list != null) {
                            if (pageNumber == 1) {
                                ...
                                sendInviationSelectPersonListAdapter.setBeforeSelectIdsList(selectCityPerson);
                            } else {
                                refreshLayout.finishLoadmore();
