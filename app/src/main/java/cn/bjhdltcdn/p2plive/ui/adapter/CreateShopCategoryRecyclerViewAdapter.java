...
public class CreateShopCategoryRecyclerViewAdapter extends BaseRecyclerAdapter {
    ...
    private int total;
    public CreateShopCategoryRecyclerViewAdapter(Activity mActivity) {
                            ...
                            //只有人为点击的时候才做此功能
                                if (labelInfo.getIsSelect()==0) {
                                    if(total<2){
                                        ...
                                        Utils.showToastShortTime("最多选中两个标签类别");
                                    }
                                } else {
                                    total--;
