 ...
 */
public class StoreTabFragmentAdapter extends FragmentPagerAdapter {
    ...
    public StoreTabFragmentAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public View getTabView(final int position) {
        View view = View.inflate(App.getInstance(), R.layout.store_tab_item_layout, null);
