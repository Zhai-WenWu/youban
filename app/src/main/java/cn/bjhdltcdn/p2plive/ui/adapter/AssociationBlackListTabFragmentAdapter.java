 ...
 */
public class AssociationBlackListTabFragmentAdapter extends FragmentPagerAdapter {
    ...
    public AssociationBlackListTabFragmentAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public View getTabView(final int position) {
        ...
        View view = View.inflate(App.getInstance(), R.layout.association_blacklist_tab_item_layout, null);
