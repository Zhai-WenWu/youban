...
public class PrivateChatGiftListFragmentAdapter  extends PagerAdapter {

    private int pageCount;
    private List<Props> list;

    private List<PrivateChatGiftAdapter> itemAdapterList;
    ...
    public PrivateChatGiftListFragmentAdapter(int pageCount, List<Props> list) {
    ...
    public List<PrivateChatGiftAdapter> getItemAdapterList() {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View rootView = View.inflate(App.getInstance(), R.layout.private_chat_gift_list_layout, null);
        ...
        final PrivateChatGiftAdapter adapter = new PrivateChatGiftAdapter(subList);
        // 默认第一页的第一item被选中
//        if (position == 0) {
