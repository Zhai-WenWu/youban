 ...
 * }
 */
public class GroupVideoGiftLayout extends LinearLayout {

    private GroupVideoGiftShowManager giftManger;

    public GroupVideoGiftLayout(Context context) {
        super(context);
        init(context);
    }

    public GroupVideoGiftLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public GroupVideoGiftLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        giftManger = new GroupVideoGiftShowManager(context, this);

    }

    public GroupVideoGiftShowManager getGroupVideoGiftShowManager() {
        return giftManger;
    }
