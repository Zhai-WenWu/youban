...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    private @SuppressLint({"Recycle", "CustomViewStyleable"})
    ...
    public VerificationCodeView(Context context, AttributeSet attrs) {
        ...
        mEtWidth = typedArray.getDimensionPixelSize(R.styleable.vericationCodeView_vcv_et_width, 100);
    ...
    private void focus() {
        ...
        if (lastEditText.getText().length() > 0) {
            KeyBoardUtils.closeKeybord(lastEditText, App.getInstance());
            getResult();
        }
    }
