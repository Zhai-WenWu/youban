...
public class ConfessionComment {
    ...
    private List<ConfessionComment> replyList;//[{Comment},{Comment}...]回复列表,
    ...
    public List<ConfessionComment> getReplyList() {
        return replyList;
    }

    public void setReplyList(List<ConfessionComment> replyList) {
