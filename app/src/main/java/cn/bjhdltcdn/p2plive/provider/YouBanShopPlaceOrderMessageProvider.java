...
@ProviderTag(messageContent = YouBanShopPlaceOrderMessage.class)
public class YouBanShopPlaceOrderMessageProvider extends IContainerItemProvider.MessageProvider {
    ...
    public Spannable getContentSummary(MessageContent messageContent) {
        ...
        YouBanShopPlaceOrderMessage youBanShopPlaceOrderMessage = (YouBanShopPlaceOrderMessage) messageContent;

        // 内容
        String content = youBanShopPlaceOrderMessage.getContent();
                    ...
                    switch (parseShopPlaceOrderMessage.getMessageType()) {
                        ...
                        case 1003:
                            ...
                            if (productOrder != null) {
                                ...
                                if (baseUser != null) {
                                    tipText = baseUser.getNickName() + "：下单成功";
                                }
    ...
    public void bindView(View view, int i, Object object) {
        ...
        if (object instanceof UIMessage) {
            ...
            if (uiMessage.getContent() instanceof YouBanShopPlaceOrderMessage) {
                YouBanShopPlaceOrderMessage youBanShopPlaceOrderMessage = (YouBanShopPlaceOrderMessage) uiMessage.getContent();

                final String content = youBanShopPlaceOrderMessage.getContent();
                Logger.json(content);
