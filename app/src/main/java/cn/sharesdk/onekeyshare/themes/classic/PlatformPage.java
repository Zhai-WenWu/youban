...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		lp2.setMargins(15, 30, 15, 30);
		TextView tv = new TextView(activity);
		tv.setGravity(Gravity.CENTER);
		tv.setText("分享至");
		tv.setTextSize(14);
		tv.setTextColor(activity.getResources().getColor(R.color.color_333333));
		tv.setBackgroundColor(Color.WHITE);

		LinearLayout.LayoutParams lp3 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,1);
		View  line=new View(activity);
		line.setBackgroundColor(activity.getResources().getColor(R.color.color_e6e6e6));

		buttonLayout.addView(tv,lp2);
		buttonLayout.addView(line,lp3);
		...
		lp22.setMargins(13, 13, 13, 13);
		Button button2 = new Button(activity);
		button2.setText("取消");
		button2.setTextSize(16);
		button2.setTextColor(activity.getResources().getColor(R.color.color_999999));
