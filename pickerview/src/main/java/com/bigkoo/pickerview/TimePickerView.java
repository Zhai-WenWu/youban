...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private boolean Show_current_time;//是否展示当前时间按钮
    ...
    private CheckBox currentTimeCheckBox;
    ...
    public TimePickerView(Builder builder) {
        ...
        this.Show_current_time=builder.Show_Current_Time;
    ...
    public static class Builder {
        ...
        private int Color_Cancel;//取消按钮颜色
        private int Color_Title;//标题颜色
        private boolean Show_Current_Time;//是否展示当前时间选择按钮
        ...
        public Builder setShow_Current_Time(boolean show_Current_Time) {
            this.Show_Current_Time = show_Current_Time;
            return this;
        }
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            currentTimeLayout= (RelativeLayout) findViewById(R.id.current_layout);
            if(Show_current_time){
                currentTimeLayout.setVisibility(View.VISIBLE);
            }else{
                currentTimeLayout.setVisibility(View.GONE);
            }
            currentTimeCheckBox=(CheckBox) findViewById(R.id.checkbox_time);
            currentTimeCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    if(b){
                        isCheck=true;
                        currentTimeCheckBox.setBackgroundResource(R.drawable.location_select_icon);
                        if (timeSelectListener != null) {
                                Date    currentDate=new    Date(System.currentTimeMillis());//获取当前时间
                                timeSelectListener.onTimeSelect(currentDate, clickView,isCheck);
                        }
                        dismiss();
                    }
                }
...
//            btnCancel.setTextColor(Color_Cancel == 0 ? pickerview_timebtn_nor : Color_Cancel);
    ...
    public void returnData() {
        if (timeSelectListener != null) {
            try {
                ...
                timeSelectListener.onTimeSelect(date, clickView,isCheck);
    ...
    public interface OnTimeSelectListener {
        void onTimeSelect(Date date, View v,boolean isCheck);
    }
